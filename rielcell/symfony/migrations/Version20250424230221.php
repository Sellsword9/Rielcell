 ...
 */
final class Version20250424230221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE repo (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, vcs VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, serverpath VARCHAR(255) DEFAULT NULL, has_directorymade TINYINT(1) NOT NULL, deleted TINYINT(1) NOT NULL, is_private TINYINT(1) NOT NULL, INDEX IDX_5C5CBBFF7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
